...
# DimPlot(obj, reduction = "umap", group.by = "clust_chat", label = TRUE) + ggtitle("Clusters") + theme(aspect.ratio = 3/4)
# dev.off()
```
...
# DimPlot(obj_fib, reduction = "umap", group.by = "SCT_snn_res.0.2", label = TRUE) + ggtitle("Clusters") + theme(aspect.ratio = 3/4)
# dev.off()
```
...
#3/19
# library(ggplot2)
# pdf("Subclustering_annotation.pdf")
# DimPlot(obj, reduction = "umap", group.by = "clust_chat_new", label = TRUE) + ggtitle("Clusters") + theme(aspect.ratio = 3/4)
# dev.off()
```
